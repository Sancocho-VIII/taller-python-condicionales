...
tarifa taxi:calcular el precio de un recorrido de taxi segun el horario y la distancia recorrida.
clasificador de notas: validar los datos ingresados por el usuario, usar varios condicionales y aplicarlo a la logica de la vida real.
